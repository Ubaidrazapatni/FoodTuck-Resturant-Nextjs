    ...
    <div className='w-[1920px] h-[657px] bg-[#0D0D0DF2]'>
      <div className='w-[1764px] h-[657px]'>
        ...
        <div className='flex ml-[300px] gap-[30px] mt-[40px]'>
          <ChefCard imageSrc='/Chef Card 1.png' name='D.Estwood' description='Chief Chef' />
          <ChefCard imageSrc='/Chef Crad 2.png' name='D.Scoriesh' description='Assistant Chef' />
          <ChefCard imageSrc='/Chef Card 3.png' name='M. William' description='Advertising Chef' />
          <ChefCard imageSrc='/Chef Card 4.png' name='W.Readfroad' description='Chef' />
        </div>
