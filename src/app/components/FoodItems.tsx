    ...
    <div className='w-[1320px] h-[489px]'>
      ...
      <div className='w-[1320px] h-[329px] flex gap-4 mt-8'>
        <div className='w-[306px] h-[329px]'>
          <Image src='/Food1.png' alt='' width={322} height={194} className='w-full h-full' />
        </div>
        <div className='w-[306px] h-[329px]'>
          <Image src='/Food2.png' alt='' width={322} height={194} className='w-full h-full' />
        </div>
        <div className='w-[306px] h-[329px]'>
          <Image src='/Food3.png' alt='' width={322} height={194} className='w-full h-full' />
        </div>
        <div className='w-[306px] h-[329px]'>
          <Image src='/Food4.png' alt='' width={322} height={194} className='w-full h-full' />
        </div>
      </div>
    </div>
