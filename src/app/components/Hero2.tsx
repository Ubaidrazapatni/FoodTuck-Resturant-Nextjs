            ...
            <div className='w-[1320px] h-[562px] mt-[120px] ml-[300px] flex'>
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='font-normal text-[18px] flex flex-col justify-center gap-4 text-[#FFFFFF]'>
                        <div className='flex gap-2'><Check /> Lacus nisi, et ac dapibus sit eu velit in consequat.</div>
                        <div className='flex gap-2'><Check /> Quisque diam pellentesque bibendum non dui volutpat</div>
                        <div className='flex gap-2'><Check /> Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                    </div>
                    <div>
